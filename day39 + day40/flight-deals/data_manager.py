...
SHEETY_PRICES_ENDPOINT = "https://api.sheety.co/6348fc7fae222c67d4dd4c567d6c5827/flightDealsDemo/prices"
...
class DataManager:
    ...
    def __init__(self):
        ...
        self.users_endpoint = os.environ["USER_ENDPOINT"]
        self.prices_endpoint = os.environ["PRICE_ENDPOINT"]
        self.customer_data = {}
